...
namespace Massive {
  ...
  public static class ObjectExtensions {
    ...
    /// </summary>
    public static IDictionary<string, object> ToDictionary(this object thingy) => (IDictionary<string, object>)thingy.ToExpando();
  }
  /// <summary>
...
#pragma warning restore 0649
    ...
    public virtual int Execute(DbCommand command) => Execute(new DbCommand[] { command });
    /// <summary>
    ...
    /// </summary>
    public virtual bool HasPrimaryKey(object o) => o.ToDictionary().ContainsKey(PrimaryKeyField);
    /// <summary>
    ...
    public virtual object GetPrimaryKey(object o) {
      o.ToDictionary().TryGetValue(PrimaryKeyField, out var result);
      return result;
    }
    ...
    /// </summary>
    public virtual int Update(object o, object key) => Execute(CreateUpdateCommand(o, key));
    /// <summary>
    /// Removes one or more records from the DB according to the passed-in WHERE
    /// </summary>
    public int Delete(object key = null, string where = "", params object[] args) => Execute(CreateDeleteCommand(where: where, key: key, args: args));
    /// <summary>
