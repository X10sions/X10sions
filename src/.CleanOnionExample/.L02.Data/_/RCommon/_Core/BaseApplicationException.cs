...
public class BaseApplicationException : ApplicationException {
  ...
  /// </summary>
  public string AppDomainName => appDomainName;

  /// <summary>
  /// Identity of the executing thread on which the exception was created.
  /// </summary>
  public string ThreadIdentityName => threadIdentity;

  /// <summary>
  /// Windows identity under which the code was running.
  /// </summary>
  public string WindowsIdentityName => windowsIdentity;

  /// <summary>
  /// Collection allowing additional information to be added to the exception.
  /// </summary>
  public NameValueCollection AdditionalInformation => additionalInformation;
