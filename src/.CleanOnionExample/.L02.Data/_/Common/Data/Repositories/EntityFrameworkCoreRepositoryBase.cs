...
public class EntityFrameworkCoreRepositoryBase<TDbContext, TEntity, TId> : IRepository<TEntity, TId>
  where TDbContext : DbContext
  where TEntity : class, IEntityWithId<TId>
  where TId : IEquatable<TId> {
  protected readonly TDbContext _dbContext;

  public EntityFrameworkCoreRepositoryBase(TDbContext dbContext) {
