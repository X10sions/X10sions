...
public class AccountService1 : IAccountService1 {
  ...
  public AccountService1(UserManager<ApplicationUser> userManager,
  ...
  public async Task<Response<Authentication.Response>> AuthenticateAsync(Authentication.Request request, string ipAddress) {
    ...
    var response = new Authentication.Response();
    response.Id = user.Id;
    ...
    return new Response<Authentication.Response>(response, $"Authenticated {user.UserName}");
  }
