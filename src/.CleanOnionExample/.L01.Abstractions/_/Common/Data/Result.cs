...
public class Result : IResult {
  ...
  public static IResult Success(string? message = null) => new Result(message);
...
public class Result<T> : Result, IResult<T> {
  ...
  public static new IResult<T> Fail(string? message = null) => new Result<T>(message, new[] { nameof(Fail) });
  ...
  public static new IResult<T> Success(string? message = null) => new Result<T>(message);
  public static IResult<T> Success(T data, string? message = null) => new Result<T>(data, message);
