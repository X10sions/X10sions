...
namespace Common.AspNetCore.Identity {
  public class LookupProtector : ILookupProtector {
    // https://github.com/blowdart/AspNetCoreIdentityEncryption/blob/master/AspNetCoreIdentityEncryption/LookupProtector.cs
    ...
    private byte[] DerivedInitializationVector(byte[] key, string plainText, SymmetricAlgorithm algorithm, int keyDerivationIterationCount) => KeyDerivation.Pbkdf2(
          plainText,
          key,
          KeyDerivationPrf.HMACSHA512,
          keyDerivationIterationCount,
