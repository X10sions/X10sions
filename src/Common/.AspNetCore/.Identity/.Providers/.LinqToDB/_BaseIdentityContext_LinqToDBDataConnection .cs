...
namespace Common.AspNetCore.Identity.Providers.LinqToDB {
  public class _BaseIdentityContext_LinqToDBDataConnection : DataConnection, IIdentityContext_LinqToDB {
    ...
    public IQueryable<T> DbGetQueryable<T>() where T : class => GetTable<T>();
    ...
    public _BaseIdentityContext_LinqToDBDataConnection(IDataProvider dataProvider, IDbConnection connection) : base(dataProvider, connection) { }
