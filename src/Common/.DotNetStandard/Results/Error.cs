...
public sealed record Error(string Code, string? Description = null, ErrorType Type = ErrorType.Unknown, string? StackTrace = null) {
  ...
  public static Error Unexpected(string code, string description) => new(code, description, StackTrace: Environment.StackTrace);
