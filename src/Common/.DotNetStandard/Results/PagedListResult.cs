...
//public record PagedListResult<T> : IPagedListOptions {
...
//  internal PagedListResult(List<T> data = default, IEnumerable<ResultError>? errors = null, long count = 0, int page = 1, int? pageSize = DefaultPageSize) {
...
//  public static PagedListResult<T> Failure(List<ResultError> errors) => new PagedListResult<T>(null, errors);
