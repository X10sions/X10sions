...
public static class IHtmlTagOldExtensions {
  ...
  public static string AttributesHtml(this IHtmlTagOld tag) {
  ...
  public static string ToHtml(this IHtmlTagOld tag, string innerHtml) => $"<{tag.TagName}{tag.AttributesHtml()}>{innerHtml}</{tag.TagName}>";
