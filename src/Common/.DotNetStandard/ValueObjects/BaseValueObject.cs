...
/// </summary>
abstract class BaseValueObject : IEquatable<BaseValueObject> {
  protected static bool EqualOperator(BaseValueObject? left, BaseValueObject? right) => ReferenceEquals(left, right) || (left is not null && left.Equals(right));
