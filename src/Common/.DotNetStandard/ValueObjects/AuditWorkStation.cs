...
public readonly record struct AuditWorkStation(string Value) : IValueObject<string> {
  //    public static implicit operator AuditWorkStation(string value) => new(value);
}
