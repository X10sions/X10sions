...
public class GenericBusinessService<T, TKey> : IGenericBusinessService<T, TKey> where T : class, IEntityWithId<TKey> where TKey : IEquatable<TKey> {
  ...
  public IBusinessResult Add(T entity) {
    ...
    try {
      ...
      businessResult.Messages.Add(new MessageResult { Message = E.Message, MessageType = MessageType.Error });
    } catch (BusinessException E) {
      businessResult = new BusinessResult();
      businessResult.Messages.Add(new MessageResult { Message = E.Message, MessageType = MessageType.Warning });
    } catch (Exception E) {
      businessResult = new BusinessResult();
      businessResult.Messages.Add(new MessageResult { Message = "Error!", MessageType = MessageType.Error });
    }
