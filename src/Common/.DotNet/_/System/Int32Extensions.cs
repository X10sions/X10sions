...
public static class Int32Extensions {
  ...
  public static IntCYYMMDD ToIntCYYMMDD(this int year, int month, int day) => new IntCYYMMDD(new(year), new(month), new(day));

  public static IntCYYMMDD_HHMMSS ToIntCYYMMDD_HHMMSS(this int cyymmdd, int hhmmss = 0) => new IntCYYMMDD_HHMMSS(cyymmdd, hhmmss);
  public static IntCYYMMDD_HHMMSS ToIntCYYMMDD_HHMMSS(this int year, int month, int day, int hour = 0, int minute = 0, int second = 0, int millisecond = 0) => new IntCYYMMDD_HHMMSS(year, month, day, hour, minute, second, millisecond);
