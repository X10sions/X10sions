...
namespace X10sions.Fake.Pages.Testing.DocXToPdfConverter {
  public static class Index {
    ...
    public static void Main(string[] args) {
      ...
      string locationOfLibreOfficeSoffice = @"F:\PortableApps\LibreOfficePortable\App\libreoffice\program\soffice.exe";


      //This is only to get this example to work (find the word docx and the html file, which were shipped with this).
