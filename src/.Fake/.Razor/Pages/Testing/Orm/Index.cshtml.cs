...
namespace X10sions.Fake.Pages.Testing.Orm {
  ...
  //  public IOrmLiteDialectProvider GetOrmLiteDialectProvider(DbTypes dbType) => dbType switch {
  ...
  //    var dbFactory = new OrmLiteConnectionFactory(connString, GetOrmLiteDialectProvider(dbType));
