...
namespace Kbg.NppPluginNET.PluginInfrastructure {
  ...
  public class ScintillaGateway : IScintillaGateway {
    ...
    public int GetSelectionLength() {
      return (int)Win32.SendMessage(scintilla, SciMsg.SCI_GETSELTEXT, Unused, Unused) - LengthZeroTerminator;
    }
    ...
    public void AddText(int length, string text) {
      var textPtr = Encoding.UTF8.GetBytes(text);
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ADDTEXT, length, textPtr);
    }
    ...
    public void AddStyledText(int length, Cells c) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ADDSTYLEDTEXT, length, c.Value);
    }
    ...
    public void InsertText(Position pos, string text) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_INSERTTEXT, pos.Value, Encoding.UTF8.GetBytes(text));
    }
    ...
    public void ChangeInsertion(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_CHANGEINSERTION, length, Encoding.UTF8.GetBytes(text));
    }
    ...
    public string GetCurLine(int length) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETCURLINE, length, textBuffer);
    ...
    public void MarkerDefinePixmap(int markerNumber, string pixmap) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARKERDEFINEPIXMAP, markerNumber, Encoding.UTF8.GetBytes(pixmap));
    }
    ...
    public void StyleSetFont(int style, string fontName) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_STYLESETFONT, style, Encoding.UTF8.GetBytes(fontName));
    }
    ...
    public string StyleGetFont(int style) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_STYLEGETFONT, style, fontNameBuffer);
    ...
    public void SetStylingEx(int length, string styles) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETSTYLINGEX, length, Encoding.UTF8.GetBytes(styles));
    }
    ...
    public void SetWordChars(string characters) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETWORDCHARS, Unused, Encoding.UTF8.GetBytes(characters));
    }
    ...
    public string GetWordChars() {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETWORDCHARS, Unused, charactersBuffer);
    ...
    public void AutoCShow(int lenEntered, string itemList) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_AUTOCSHOW, lenEntered, Encoding.UTF8.GetBytes(itemList));
    }
    ...
    public void AutoCStops(string characterSet) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_AUTOCSTOPS, Unused, Encoding.UTF8.GetBytes(characterSet));
    }
    ...
    public void AutoCSelect(string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_AUTOCSELECT, Unused, Encoding.UTF8.GetBytes(text));
    }
    ...
    public void AutoCSetFillUps(string characterSet) {
      //fixed (byte* characterSetPtr = Encoding.UTF8.GetBytes(characterSet)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_AUTOCSETFILLUPS, Unused, Encoding.UTF8.GetBytes(characterSet));
    }
    ...
    public void UserListShow(int listType, string itemList) {
      //fixed (byte* itemListPtr = Encoding.UTF8.GetBytes(itemList)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_USERLISTSHOW, listType, Encoding.UTF8.GetBytes(itemList));
    }
    ...
    public void RegisterImage(int type, string xpmData) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_REGISTERIMAGE, type, Encoding.UTF8.GetBytes(xpmData));
    }
    ...
    public string GetLine(int line) {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETLINE, line, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public string GetSelText() {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETSELTEXT, Unused, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public void ReplaceSel(string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_REPLACESEL, Unused, Encoding.UTF8.GetBytes(text));
    }
    ...
    public void SetText(string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETTEXT, Unused, Encoding.UTF8.GetBytes(text));
    }
    ...
    public string GetText(int length) {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETTEXT, length, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public string GetTargetText() {
      byte[] charactersBuffer = new byte[10000];
      //fixed (byte* charactersPtr = charactersBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETTARGETTEXT, Unused, charactersBuffer);
      return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
    }
    ...
    public int ReplaceTarget(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_REPLACETARGET, length, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public int ReplaceTargetRE(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_REPLACETARGETRE, length, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public int SearchInTarget(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SEARCHINTARGET, length, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public void CallTipShow(Position pos, string definition) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_CALLTIPSHOW, pos.Value, Encoding.UTF8.GetBytes(definition));
    }
    ...
    public int TextWidth(int style, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_TEXTWIDTH, style, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public void AppendText(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_APPENDTEXT, length, Encoding.UTF8.GetBytes(text));
    }
    ...
    public string GetTag(int tagNumber) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETTAG, tagNumber, tagValueBuffer);
    ...
    public int SearchNext(int flags, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SEARCHNEXT, flags, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public int SearchPrev(int flags, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SEARCHPREV, flags, Encoding.UTF8.GetBytes(text));
      return (int)res;
    }
    ...
    public void CopyText(int length, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_COPYTEXT, length, Encoding.UTF8.GetBytes(text));
    }
    ...
    public void SetWhitespaceChars(string characters) {
      //fixed (byte* charactersPtr = Encoding.UTF8.GetBytes(characters)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETWHITESPACECHARS, Unused, Encoding.UTF8.GetBytes(characters));
    }
    ...
    public string GetWhitespaceChars() {
      byte[] charactersBuffer = new byte[10000];
      //fixed (byte* charactersPtr = charactersBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETWHITESPACECHARS, Unused, charactersBuffer);
      return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
    }
    ...
    public void SetPunctuationChars(string characters) {
      //fixed (byte* charactersPtr = Encoding.UTF8.GetBytes(characters)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETPUNCTUATIONCHARS, Unused, Encoding.UTF8.GetBytes(characters));
    }
    ...
    public string GetPunctuationChars() {
      byte[] charactersBuffer = new byte[10000];
      //fixed (byte* charactersPtr = charactersBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETPUNCTUATIONCHARS, Unused, charactersBuffer);
      return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
    }
    ...
    public string AutoCGetCurrentText() {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_AUTOCGETCURRENTTEXT, Unused, sBuffer);
    ...
    public string TargetAsUTF8() {
      byte[] sBuffer = new byte[10000];
      //fixed (byte* sPtr = sBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_TARGETASUTF8, Unused, sBuffer);
      return Encoding.UTF8.GetString(sBuffer).TrimEnd('\0');
    }
    ...
    public string EncodedFromUTF8(string utf8) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ENCODEDFROMUTF8, Encoding.UTF8.GetBytes(utf8), encodedBuffer);
    ...
    public void MarginSetText(int line, string text) {
      //fixed (byte* textPtr = Encoding.UTF8.GetBytes(text)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARGINSETTEXT, line, Encoding.UTF8.GetBytes(text));
    }
    ...
    public string MarginGetText(int line) {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARGINGETTEXT, line, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public void MarginSetStyles(int line, string styles) {
      //fixed (byte* stylesPtr = Encoding.UTF8.GetBytes(styles)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARGINSETSTYLES, line, Encoding.UTF8.GetBytes(styles));
    }
    ...
    public string MarginGetStyles(int line) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARGINGETSTYLES, line, stylesBuffer);
    ...
    public void AnnotationSetText(int line, string text) {
      //fixed (byte* textPtr =) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETTEXT, line, Encoding.UTF8.GetBytes(text));
    }
    ...
    public string AnnotationGetText(int line) {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETTEXT, line, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public void AnnotationSetStyles(int line, string styles) {
      //fixed (byte* stylesPtr = Encoding.UTF8.GetBytes(styles)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETSTYLES, line, Encoding.UTF8.GetBytes(styles));
    }
    ...
    public string AnnotationGetStyles(int line) {
      byte[] stylesBuffer = new byte[10000];
      //fixed (byte* stylesPtr = stylesBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETSTYLES, line, stylesBuffer);
      return Encoding.UTF8.GetString(stylesBuffer).TrimEnd('\0');
    }
    ...
    public void MarkerDefineRGBAImage(int markerNumber, string pixels) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_MARKERDEFINERGBAIMAGE, markerNumber, Encoding.UTF8.GetBytes(pixels));
    }
    ...
    public void RegisterRGBAImage(int type, string pixels) {
      //fixed (byte* pixelsPtr = Encoding.UTF8.GetBytes(pixels)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_REGISTERRGBAIMAGE, type, Encoding.UTF8.GetBytes(pixels));
    }
    ...
    public void SetRepresentation(string encodedCharacter, string representation) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETREPRESENTATION, Encoding.UTF8.GetBytes(encodedCharacter), Encoding.UTF8.GetBytes(representation));
    }
    ...
    public string GetRepresentation(string encodedCharacter) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETREPRESENTATION, Encoding.UTF8.GetBytes(encodedCharacter), representationBuffer);
    ...
    public void ClearRepresentation(string encodedCharacter) {
      //fixed (byte* encodedCharacterPtr = Encoding.UTF8.GetBytes(encodedCharacter)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_CLEARREPRESENTATION, Encoding.UTF8.GetBytes(encodedCharacter), Unused);
    }
    ...
    public void SetProperty(string key, string value) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETPROPERTY, Encoding.UTF8.GetBytes(key), Encoding.UTF8.GetBytes(value));
    }
    ...
    public void SetKeyWords(int keywordSet, string keyWords) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETKEYWORDS, keywordSet, Encoding.UTF8.GetBytes(keyWords));
    }
    ...
    public void SetLexerLanguage(string language) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETLEXERLANGUAGE, Unused, Encoding.UTF8.GetBytes(language));
    }
    ...
    public void LoadLexerLibrary(string path) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_LOADLEXERLIBRARY, Unused, Encoding.UTF8.GetBytes(path));
    }
    ...
    public string GetProperty(string key) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETPROPERTY, Encoding.UTF8.GetBytes(key), bufBuffer);
    ...
    public string GetPropertyExpanded(string key) {
      ...
      byte[] bufBuffer = new byte[10000];
      //fixed (byte* bufPtr = bufBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETPROPERTYEXPANDED, Encoding.UTF8.GetBytes(key), bufBuffer);
      return Encoding.UTF8.GetString(bufBuffer).TrimEnd('\0');
    }
    ...
    public int GetPropertyInt(string key) {
      //fixed (byte* keyPtr = Encoding.UTF8.GetBytes(key)) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETPROPERTYINT, Encoding.UTF8.GetBytes(key), Unused);
      return (int)res;
    }
    ...
    public string GetLexerLanguage() {
      byte[] textBuffer = new byte[10000];
      //fixed (byte* textPtr = textBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETLEXERLANGUAGE, Unused, textBuffer);
      return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
    }
    ...
    public string PropertyNames() {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_PROPERTYNAMES, Unused, namesBuffer);
    ...
    public int PropertyType(string name) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_PROPERTYTYPE, Encoding.UTF8.GetBytes(name), Unused);
      return (int)res;
    }
    ...
    public string DescribeProperty(string name) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_DESCRIBEPROPERTY, Encoding.UTF8.GetBytes(name), descriptionBuffer);
    ...
    public string DescribeKeyWordSets() {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_DESCRIBEKEYWORDSETS, Unused, descriptionsBuffer);
    ...
    public void SetIdentifiers(int style, string identifiers) {
      ...
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_SETIDENTIFIERS, style, Encoding.UTF8.GetBytes(identifiers));
    }
    ...
    public string GetSubStyleBases() {
      byte[] stylesBuffer = new byte[10000];
      //fixed (byte* stylesPtr = stylesBuffer) {
      IntPtr res = Win32.SendMessage(scintilla, SciMsg.SCI_GETSUBSTYLEBASES, Unused, stylesBuffer);
      return Encoding.UTF8.GetString(stylesBuffer).TrimEnd('\0');
    }
