...
namespace RepoDb.StatementBuilders {
  public class DB2iSeries_SqLiteStatementBuilder<TConnection> : BaseStatementBuilder where TConnection : DbConnection, IDbConnection {

    public DB2iSeries_SqLiteStatementBuilder()
    ...
    public DB2iSeries_SqLiteStatementBuilder(IDbSetting dbSetting, IResolver<Field, IDbSetting, string> convertFieldResolver = null, IResolver<Type, Type> averageableClientTypeResolver = null)
