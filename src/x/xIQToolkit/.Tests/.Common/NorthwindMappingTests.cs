...
namespace Test {
  public abstract partial class NorthwindMappingTests : QueryTestBase {
    ...
    public void TestBasicMapping_AttributesOnEntity() {
      var provider = GetProvider().WithMapping(new AttributeMapping());
    ...
    public void TestBasicMapping_AttributesOnContext() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Basic_AttributesOnContext.Context)));
    ...
    public void TestBasicMapping_AttributesOnContext_TableNameInferred() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Basic_AttributesOnContext_TableNameInferred.Context)));
    ...
    public void TestBasicMapping_AttributesOnContext_RuntimeType() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Basic_AttributesOnContext_RuntimeType.Context)));
...
";
    ...
    public void TestBasicMapping_XmlMapped() {
      var provider = GetProvider().WithMapping(XmlMapping.FromXml(Basic_XmlMapped.Xml));
...
";
    ...
    public void TestAssociation_AttributesOnContext_Orders() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Association_AttributesOnContext.Context)));
...
";
    ...
    public void TestNestedEntity_AttributesOnContext() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Nested_AttributesOnContext.Context)));
    ...
    public void TestNestedEntity_AttributesOnContext_DeeplyNested() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(Nested_AttributesOnContext_DeeplyNested.Context)));
...
";
    ...
    public void TestNestedEntity_XmlMapped() {
      var provider = GetProvider().WithMapping(XmlMapping.FromXml(Nested_XmlMapped.Xml));
...
";
    ...
    public void TestMultiTable_AttributesOnContext() {
      var provider = GetProvider().WithMapping(new AttributeMapping(typeof(MultiTable_AttributesOnContext.Context)));
...
";
    ...
    public void TestMultiTable_XmlMapped() {
      var provider = GetProvider().WithMapping(XmlMapping.FromXml(MultiTable_XmlMapped.Xml));
