...
namespace IQToolkit.Data.Common {
  ...
  public class DbExpressionReplacer : DbExpressionVisitor {
    ...
    public static Expression Replace(Expression expression, Expression searchFor, Expression replaceWith) => new DbExpressionReplacer(searchFor, replaceWith).Visit(expression);
