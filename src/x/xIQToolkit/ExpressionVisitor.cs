  ...
  public abstract class ExpressionVisitor {
    ...
    public virtual Expression Visit(Expression exp) {
      ...
      switch (exp.NodeType) {
        ...
        case ExpressionType.UnaryPlus: return VisitUnary((UnaryExpression)exp);
        ...
        case ExpressionType.Power: return VisitBinary((BinaryExpression)exp);
        case ExpressionType.TypeIs: return VisitTypeIs((TypeBinaryExpression)exp);
        case ExpressionType.Conditional: return VisitConditional((ConditionalExpression)exp);
        ...
        case ExpressionType.NewArrayBounds: return VisitNewArray((NewArrayExpression)exp);
        ...
        case ExpressionType.ListInit: return VisitListInit((ListInitExpression)exp);
        default: return VisitUnknown(exp);
      }
    }
    ...
    protected virtual MemberBinding VisitBinding(MemberBinding binding) {
      switch (binding.BindingType) {
        ...
        default: throw new Exception(string.Format("Unhandled binding type '{0}'", binding.BindingType));
      }
    }
