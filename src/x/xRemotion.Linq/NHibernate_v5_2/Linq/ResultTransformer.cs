...
namespace NHibernate_v5_2.Linq {
  ...
  public class ResultTransformer : IResultTransformer, IEquatable<ResultTransformer> {
    ...
    public object TransformTuple(object[] tuple, string[] aliases) => _itemTransformation == null ? tuple : _itemTransformation(tuple);
    ...
    public override bool Equals(object obj) => Equals(obj as ResultTransformer);
