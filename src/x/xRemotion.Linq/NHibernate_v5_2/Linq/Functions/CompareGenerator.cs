...
using NHibernate_v5_2.Linq.Visitors;
using System;
...
namespace NHibernate_v5_2.Linq.Functions {
  internal class CompareGenerator : BaseHqlGeneratorForMethod, IRuntimeMethodHqlGenerator {
    private static readonly HashSet<MethodInfo> ActingMethods = new HashSet<MethodInfo> {
      ...
      ReflectHelper.GetMethodDefinition(() => decimal.Compare(default, default)),
    ...
    public override HqlTreeNode BuildHql(MethodInfo method, Expression targetObject, ReadOnlyCollection<Expression> arguments, HqlTreeBuilder treeBuilder, IHqlExpressionVisitor visitor) {
      ...
      var lhs1 = visitor.Visit(lhs).AsExpression();
      var rhs1 = visitor.Visit(rhs).AsExpression();
      var lhs2 = visitor.Visit(lhs).AsExpression();
      var rhs2 = visitor.Visit(rhs).AsExpression();
    ...
    public bool SupportsMethod(MethodInfo method) =>
      ...
      IsCompareMethod(method);


    public IHqlGeneratorForMethod GetMethodGenerator(MethodInfo method) => this;
