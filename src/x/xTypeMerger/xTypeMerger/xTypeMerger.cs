...
namespace xTypeMerger {
  ...
  public static class xTypeMerger {
    ...
    /// </summary>
    internal static object Merge(object values1, object values2, xTypeMergerPolicy policy) {
    ...
    public static xTypeMergerPolicy Ignore(Expression<Func<object>> ignoreProperty) => new xTypeMergerPolicy().Ignore(ignoreProperty);
    ...
    /// <returns>TypeMerger policy used in method chaining.</returns>
    public static xTypeMergerPolicy Use(Expression<Func<object>> useProperty) => new xTypeMergerPolicy().Use(useProperty);
    ...
    /// </summary>
    private static TypeBuilder CreateTypeBuilder(string typeName) => modBuilder.DefineType(typeName, TypeAttributes.Public, typeof(object));
