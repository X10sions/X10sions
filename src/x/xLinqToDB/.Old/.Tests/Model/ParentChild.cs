...
namespace LinqToDB.Tests.Model {
  ...
  public class Parent : IEquatable<Parent>, IComparable {
    ...
    [Association(ThisKey = nameof(ParentID), OtherKey = "ParentID")] public List<Child> Children = null!;
    [Association(ThisKey = nameof(ParentID), OtherKey = "ParentID")] public List<GrandChild> GrandChildren = null!;
    [Association(ThisKey = "ParentID, Value1", OtherKey = "ParentID, Value1")] public Parent? ParentTest;
    [Association(ThisKey = nameof(ParentID), OtherKey = "ParentID")] public IEnumerable<Child> Children2 => Children;
    [Association(ThisKey = nameof(ParentID), OtherKey = "ParentID")] public ImmutableList<Child> Children3 = null!;
    ...
    static Expression<Func<Parent, ITestDataContext, IEnumerable<GrandChild>>> GrandChildren2Impl() => (p, db) =>
    ...
    public IEnumerable<GrandChild> GrandChildrenByID(int id) => throw new NotImplementedException();

    static Expression<Func<Parent, int, ITestDataContext, IEnumerable<GrandChild>>> GrandChildrenByIDImpl() => (p, id, db) =>
         from gc in db.GrandChild
  ...
  public class Child {
    ...
    public override bool Equals(object? obj) => Equals(obj as Child);
  ...
  public class Parent4 : IEquatable<Parent4>, IComparable {
    ...
    public override string ToString() => $"ParentID: {ParentID}, Value1: {Value1}";
  }
  ...
  public abstract class ParentInheritanceBase : IEquatable<ParentInheritanceBase>, IComparable {
    ...
    public override int GetHashCode() => ParentID;
  ...
  public class ParentInheritance1 : ParentInheritanceBase, IEquatable<ParentInheritance1> {
    ...
    public bool Equals(ParentInheritance1? other) => base.Equals(other) && other.Value1.Equals(Value1);
  ...
  public class ParentInheritanceValue : ParentInheritanceBase {
    ...
    public override bool Equals(object? obj) => base.Equals(obj) && Equals((ParentInheritanceValue)obj);

    public bool Equals(ParentInheritanceValue other) => base.Equals(other) && other.Value1.Equals(Value1);
  ...
  public class ParentInheritance14 : ParentInheritanceBase4 {
    [Column(IsDiscriminator = true)]
    public override Parent4Type Value1 => Parent4Type.Value1;
  }

  public class ParentInheritance24 : ParentInheritanceBase4 {
    [Column(IsDiscriminator = true)]
    public override Parent4Type Value1 => Parent4Type.Value2;
  }
