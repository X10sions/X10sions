namespace LinqToDB.Tests.Base {
  ...
  public static class TestProvName {
    public const string AS400 = "AS400_iDB2Connection";
    public const string AS400Odbc = "AS400_OdbcConnection";
    public const string AS400OleDb = "AS400_OleDbConnection";
    public const string DB2iSeries = "DB2iSeries_iDB2Connection";
    public const string DB2iSeriesOdbc = "DB2iSeries_OdbcConnection";
    public const string DB2iSeriesOleDb = "DB2iSeries_OleDbConnection";
