...
//    static void AppendConversion(StringBuilder stringBuilder, int value) => stringBuilder
//        .Append("chr(")
//        .Append(value)
//        .Append(")")
//        ;
...
//    static void ConvertCharToSql(StringBuilder stringBuilder, char value) => DataTools.ConvertCharToSql(stringBuilder, "'", AppendConversion, value);
