...
class DB2iSeriesInsertOrUpdate<T1> : Internal.CommonProvider.InsertOrUpdateProvider<T1> where T1 : class {
  public DB2iSeriesInsertOrUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression)
...
class OdbcDB2iSeriesInsertOrUpdate<T1> : Internal.CommonProvider.InsertOrUpdateProvider<T1> where T1 : class {
  public OdbcDB2iSeriesInsertOrUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression)
      : base(orm, commonUtils, commonExpression) {
  }
