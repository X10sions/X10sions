...
class OdbcDB2iSeriesUpdate<T1> : Internal.CommonProvider.UpdateProvider<T1> {

  public OdbcDB2iSeriesUpdate(IFreeSql orm, CommonUtils commonUtils, CommonExpression commonExpression, object dywhere)
