...
namespace FreeSql.Internal.CommonProvider {
  public class xDbConnectionPool : DbConnectionPool {
    internal xDataType _dataType;
    internal Func<DbConnection> _connectionFactory;
    public DbConnection TestConnection { get; }
    public bool IsSingletonConnection { get; }
    int _id;
    public xDbConnectionPool(xDataType dataType, Func<DbConnection> connectionFactory) : base(DataType.Custom, connectionFactory) {
  ...
  internal class DbConnectionPoolPolicy : IPolicy<DbConnection> {
    xDbConnectionPool Pool;
    public DbConnectionPoolPolicy(xDbConnectionPool pool) {
      this.Pool = pool;
    }
