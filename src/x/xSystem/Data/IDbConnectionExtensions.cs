...
namespace System.Data {
  public static class IDbConnectionExtensions {
    ...
    public static T EnsureNotNullAndOpen<T>(this T dbConnection, Func<T> connectionFactory
      ...
      , Action beforeOpenConnectionAction = null, Action afterOpenConnectionAction = null) where T : IDbConnection
      => dbConnection
    ...
    public static T EnsureOpen<T>(this T connection, Action beforeOpenConnectionAction = null
      , Action afterOpenConnectionAction = null) where T : IDbConnection, IDisposable {
