  ...
  private SqlNode VisitInner(Expression node) {
    ...
    try {
      switch (node.NodeType) {
        ...
        case ExpressionType.ListInit: return this.VisitListInit((ListInitExpression)node);
        case ExpressionType.Quote: return this.Visit(((UnaryExpression)node).Operand);
