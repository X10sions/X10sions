...
namespace System.Web.WebPages.Html {
  public static class SelectListItemExtensions {
    ...
    public static IEnumerable<SelectListItem> AsSelectListItems<T>(this T selectedValue) where T : Enum => AsSelectListItems(new[] { selectedValue });

    public static IEnumerable<SelectListItem> AsSelectListItems<T>(this T[] selectedValues) where T : Enum
      => Enum.GetValues(typeof(T)).Cast<T>().Select(x => new SelectListItem {
    ...
    public static IEnumerable<SelectListItem> EnumToSelectList<T>(this T[] selectedValues) where T : Enum
      => from T x in Enum.GetValues(typeof(T))
