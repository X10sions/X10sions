...
namespace Microsoft.WindowsAPICodePack.Shell {
  ...
  public static class KnownFolderHelper {
    ...
    /// <returns></returns>
    public static IKnownFolderNative FromPIDL(IntPtr pidl) {
      KnownFolderManagerClass knownFolderManager = new KnownFolderManagerClass();

      HResult hr = knownFolderManager.FindFolderFromIDList(pidl, out var knownFolder);
    ...
    public static IKnownFolder FromKnownFolderId(Guid knownFolderId) {
      ...
      HResult hr = knownFolderManager.GetFolder(knownFolderId, out var knownFolderNative);
    ...
    public static IKnownFolder FromKnownFolderIdInternal(Guid knownFolderId) {
