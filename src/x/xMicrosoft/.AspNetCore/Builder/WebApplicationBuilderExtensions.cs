...
public static class WebApplicationBuilderExtensions {
  ...
  public static T? ConfigureAppSettings<T>(this WebApplicationBuilder builder, ServiceLifetime? lifetime, bool doValidate) where T : class
    => builder.ConfigureAppSettings<T>(builder.Configuration, lifetime, doValidate);

  public static T? ConfigureAppSettings<T>(this WebApplicationBuilder builder, string configurationSectionName, ServiceLifetime? lifetime, bool doValidate) where T : class
    => builder.ConfigureAppSettings<T>(builder.Configuration.GetSection(configurationSectionName, doValidate), lifetime, doValidate);

  static T? ConfigureAppSettings<T>(this WebApplicationBuilder builder, IConfiguration configuration, ServiceLifetime? lifetime, bool doValidate) where T : class {
